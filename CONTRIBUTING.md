...
This repo is based on Andrew Arnott's standard library template, used by several other .NET repos. See https://aka.ms/lib.template and https://github.com/aarnott/Library.Template. Periodically we should follow the steps there to get the latest updates in the template. In brief those steps are:
